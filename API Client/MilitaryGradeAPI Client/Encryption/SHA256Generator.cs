...
namespace MilitaryGradeAPI_Client.Encryption
{
    internal class SHA256Generator
    {
        ...
        /// <summary>
        /// SHA256 is the world standard for military and governmental organizations. 
        /// <br></br>
        ...
        /// <br></br>
        /// Only the user should ever know what the password is, we only store the hash of the pword on the server, and use only the hash in transmission.
        /// </summary>
